...
<body class="project">
  ...
  <div class="social-bar">
    <a class="social-link" href="https://www.facebook.com/share/16oySbzXpg/" target="_blank">
      <i class="fab fa-facebook-f"></i>
    </a>
    <a class="social-link" href="mailto:rickmarcarnado@mail.com" target="_blank">
      <i class="fa-solid fa-envelope"></i>
    </a>
    <a class="social-link" href="viber://chat?number=+639942812790" target="_blank">
      <i class="fab fa-viber"></i>
    </a>
    <a class="social-link" href="https://www.instagram.com/urfav_makooy/" target="_blank">
